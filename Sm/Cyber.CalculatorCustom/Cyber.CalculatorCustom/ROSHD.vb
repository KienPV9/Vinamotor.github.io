...
#Region "Columns Edit"
    ...
    Dim EditTen_Vt, EditDvt, EditSL_Ton, EditSL_RO, EditSL_Xuat, EditSL_Da_Xuat, EditSL_Xuat_Pick, EditStt_rec0, EditSL_Da_Xuat_Pick, EditSL_CL, EditGia2, EditThue, EditTien2, EditSo_RO, Editma_cv, EditTen_cv3, Editma_ctcv, EditGhi_chu As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    ...
    Private Sub V_LoadRo(ByVal _Load As String, ByVal _Load1 As String)
        ...
        Dim DsTmpRO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHDDetail1", _Load + "#" + _Load1 + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub V_Loaddatatabse(ByVal _Status As String, ByVal _So_Ro As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHDDetail", _Status + "#" + _So_Ro + "#" + _Pick + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub DetailGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuChoGRV.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, 0, "Cập nhật thông tin công việc", AddressOf V_Congviec, Nothing, Nothing, True, True), True).BeginGroup = True
    ...
    Private Function Tao_Px(ByVal _Loai As String, ByVal iRow As Integer) As String
        ...
        For i = j To nCount
            ...
            _StrSave = _StrSave + ";INSERT KTVKTVKTV SELECT '" & Dv_Ro.Item(i).Item("So_RO").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ma_vt").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ten_vt").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ma_cv").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ten_cv3").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ma_ctcv").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("stt_rec0").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ghi_chu").ToString.Trim & "'"
        Next
        If _StrSave = "" Then Return ""

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ApprolHDS", _Loai + "#" + _StrSave & "#" & TxtSo_Ro.Text & "#" & TxtMa_Xe.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If CyberSupport.V_MsgChk(DsTmp.Tables(0), Me.Sysvar, M_LAN) = True Then
            ...
            DsTmp.Dispose()
        End If
        MsgBox("Cập nhật thông tin thành công !", MsgBoxStyle.OkOnly, "Sửa công việc dịch vụ")
    ...
    Private Sub V_Sanh_Sach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Cp_name As String = "CP_ROSHDFilter"
