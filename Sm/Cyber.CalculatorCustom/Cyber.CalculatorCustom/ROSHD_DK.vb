...
#End Region
    ...
    Private Sub V_LoadRo(ByVal _Load As String, ByVal _Load1 As String)
        ...
        Dim DsTmpRO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_DKDetail1", _Load + "#" + _Load1 + "#" + Dt1.ToString("yyyyMMdd") + "#" + Dt2.ToString("yyyyMMdd") + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub V_Loaddatatabse(ByVal _Status As String, ByVal _So_Ro As String)
        ...
        Dim Dt1 As Date = Txtngay_ct1.Value
        Dim Dt2 As Date = Txtngay_ct2.Value
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_DKDetail", _Status + "#" + _So_Ro + "#" + _Pick + "#" + Dt1.ToString("yyyyMMdd") + "#" + Dt2.ToString("yyyyMMdd") + "#" + IIf(Chkis_Hd.Checked, "1", "0") + "#" + CbBMa_TT.SelectedValue + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
        ...
        If DsTmp.Tables(0).Columns.Contains("SO_HD") Then TxtSo_NK.Text = DsTmp.Tables(0).Rows(0).Item("SO_HD")
    ...
    Private Function Tao_Px(ByVal _Loai As String, ByVal iRow As Integer) As String
        ...
        For i = j To nCount
            ...
            _StrSave = _StrSave + ";INSERT KTVKTVKTV SELECT '" & Dv_Ro.Item(i).Item("Ma_Kh").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ftag").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("SO_CT").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("So_Ro").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ngay_DK").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ghi_chu").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("So_HD").ToString.Trim & "'"
        Next
        If _StrSave = "" Then Return ""

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ApprolSDH_DK", _Loai + "#" + _StrSave & "#" & TxtSo_Ro.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_danh_sach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim Dt1 As Date = Txtngay_ct1.Value
        Dim Dt2 As Date = Txtngay_ct2.Value
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_DK_Detail_Search", _status & "#" & Dt1.ToString("yyyyMMdd") & "#" & Dt2.ToString("yyyyMMdd") & "#" & TxtMa_KH.Text.ToString.Trim & "#" & TxtSo_NK.Text.ToString.Trim & "#" & IIf(Chkis_Hd.Checked, "1", "0") & "#" & CbBMa_TT.SelectedValue & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name)
