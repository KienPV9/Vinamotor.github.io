...
#Region "Load"
    ...
    Protected Overrides Sub V_Load()
        ...
        '--Tk_CL_VT
        RemoveHandler TxtTk_621.CyberValiting, AddressOf V_Tk_CL_VT
        RemoveHandler TxtTk_621.CyberLeave, AddressOf L_Tk_CL_VT
        AddHandler TxtTk_621.CyberValiting, AddressOf V_Tk_CL_VT
        AddHandler TxtTk_621.CyberLeave, AddressOf L_Tk_CL_VT
        '--Tk_CK
