...
#Region "LoadtoComb"
    ...
    End Sub
    Private Sub V_LoadMa_Mau_NT()
        Dim DsTbma_mau As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CRQLKHTNLoadTable", "Ma_Mau_NT#" & M_Ma_Dvcs & "#" & M_User_Name)
        tbmau = DsTbma_mau.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(Me.CmbMa_Mau_NT, tbmau, "Ma_Mau_NT", "Ten_Mau")
    End Sub
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        txtten_Mau_NT.Text = CmbMa_Mau_NT.Text
