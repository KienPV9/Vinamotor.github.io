...
#End Region
    Private Sub HC1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        'EditMa_CC.V_ActiLookUpColumn(AddressOf V_Ma_Vt, AddressOf L_Ma_Vt)
...
#Region "Valid --- Ma_BP_H"
    Private Sub V_Ma_BP_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_Bp_H.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BP", "DmBP_VPP", "1=1", "1=1")
    End Sub
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetail(ByVal _Loai As String, ByVal _So As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetHC1", _Loai & "#" & _So & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetSD(ByVal iRow As Integer)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If iRow < 0 Then Exit Sub
        Dim _Ma_Vt As String = Dv_DetailTmp.Item(iRow).Item("Ma_cc").ToString.Trim
        ...
        Dim _Return As DataRow = CyberSupport.V_SetSD(StatusFooter1, AppConn, "CC", M_Mode, _Ma_Vt, _Ma_kho, _Ma_Vitri, _Ma_Lo, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_Cc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Ma_kho_I").ToString.Trim = "" Then Dv_DetailTmp.Item(iRow).Item("Ma_kho_I") = DrReturn.Item("Ma_Kho").ToString.Trim
        'If Dv_DetailTmp.Item(iRow).Item("Ma_Vitri").ToString.Trim = "" Then Dv_DetailTmp.Item(iRow).Item("Ma_Vitri") = DrReturn.Item("Ma_Vitri").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Gia_Nt") = DrReturn.Item("Gia_Nt").ToString.Trim
        'If Dv_DetailTmp.Item(iRow).Item("Gia_Nt") = 0 Then Dv_DetailTmp.Item(iRow).Item("Gia_Nt") = DrReturn.Item("Gia_Nt").ToString.Trim
    ...
    Private Sub Tinh_Gia2(ByVal iRow As Integer)
        ...
        dsGia2 = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHC1Gia2", _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec & "#" & M_Mode & "#" &
