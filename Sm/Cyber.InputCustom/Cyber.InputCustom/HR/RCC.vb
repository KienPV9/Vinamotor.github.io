...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetCa()
        ...
        CyberFill.V_FillComBoxValue(Me.CmbCa, tbKQ, "Ma_Ca", "Ten_Ca", "")
    End Sub
...
#Region "Valid --- Ma_BP_H"
    ...
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtMa_BP_H.Text.Trim = "" Then
            ...
            Exit Sub
        Else
            Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GETChamCong_RCC", M_Stt_Rec & "#" & M_Ma_CT & "#" & TxtMa_BP_H.Text & "#" & _Ngay_ct.ToString("yyyyMMdd") & "#" & CmbCa.SelectedValue & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("Ma_BP_I") = TxtMa_BP_H.Text.Trim
