...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editma_chucdanh, editis_nghi, editDiem_KPI, editSL_VP, editDiem_tru, editDiem_con_lai, editSL_VP_QL, editDiem_chuan, editDiem_DG As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        editDiem_DG.GetColumn(DetailGRV, "Diem_DG")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtMa_BP_H1.CyberValiting, AddressOf V_Ma_BP1
        AddHandler TxtMa_BP_H1.CyberLeave, AddressOf L_Ma_BP1

        AddHandler TxtMa_bp_h.CyberValiting, AddressOf V_Ma_BP2
        AddHandler TxtMa_bp_h.CyberLeave, AddressOf L_Ma_bp2

        AddHandler Txtma_hs_h.CyberValiting, AddressOf V_Ma_hs_H
        AddHandler Txtma_hs_h.CyberLeave, AddressOf L_Ma_hs_H
        AddHandler Txtma_hs_h1.CyberValiting, AddressOf V_Ma_hs_H1
        AddHandler Txtma_hs_h1.CyberLeave, AddressOf L_Ma_hs_H1
        AddHandler TxtMa_chucvu1.CyberValiting, AddressOf V_Ma_chucvu1
        AddHandler TxtMa_chucvu1.CyberLeave, AddressOf L_Ma_chucvu1
        AddHandler TxtMa_chucvu.CyberValiting, AddressOf V_Ma_chucvu2
        AddHandler TxtMa_chucvu.CyberLeave, AddressOf L_Ma_chucvu2
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not editDiem_DG.Column Is Nothing Then AddHandler editDiem_DG.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Valid --- Ma_BP_H"
    ...
    Private Sub V_UPDATE_HS()
        ...
        DsTmp.Dispose()
    End Sub
    Private Sub V_Ma_HS_H1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Txtma_hs_h1.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_HS", "DmHS", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_HS_H1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Txtma_hs_h1.Text = "" Then
            TxtTen_hs_h1.Text = ""
            Exit Sub
        End If
        DrReturn = Txtma_hs_h1.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            Txtma_hs_h1.Text = DrReturn.Item("Ma_HS")
            TxtTen_hs_h1.Text = DrReturn.Item("Ten_HS")
        Else
            Txtma_hs_h1.Text = ""
            TxtTen_hs_h1.Text = ""
        End If
        If Txtma_hs_h1.Text.Trim <> "" Then V_UPDATE_HS1()
    End Sub
    Private Sub V_UPDATE_HS1()
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue.ToString.Trim
        Dim _Ma_Post As String = CbbMa_Post.SelectedValue.ToString.Trim
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HRUpdateMa_HS", Txtma_hs_h1.Text & "#" & _Ma_GD & "#" & _Ma_Post & "#" & _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For i As Integer = 0 To DsTmp.Tables.Count - 1
            CyberSmodb.SetNotNullTable(DsTmp.Tables(i))
        Next
        If DsTmp.Tables.Count <= 1 Then
        ...
        If DsTmp.Tables(1).Columns.Contains("Ma_BP") Then TxtMa_BP_H1.Text = DsTmp.Tables(1).Rows(0).Item("Ma_BP")
        If DsTmp.Tables(1).Columns.Contains("Ten_BP") Then TxtTen_BP_h1.Text = DsTmp.Tables(1).Rows(0).Item("Ten_BP")

        If DsTmp.Tables(1).Columns.Contains("Ma_Chucvu") Then TxtMa_chucvu1.Text = DsTmp.Tables(1).Rows(0).Item("Ma_Chucvu")
        If DsTmp.Tables(1).Columns.Contains("Ten_Chucvu") Then TxtTen_chucvu1.Text = DsTmp.Tables(1).Rows(0).Item("Ten_Chucvu")

        DsTmp.Dispose()
    End Sub
    Private Sub V_Ma_chucvu1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_chucvu1.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_chucvu", "Dmchucvu", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_chucvu1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_chucvu1.Text = "" Then
            TxtTen_chucvu1.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_chucvu1.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_chucvu1.Text = DrReturn.Item("Ma_chucvu")
            TxtTen_chucvu1.Text = DrReturn.Item("Ten_chucvu")
        Else
            TxtMa_chucvu1.Text = ""
            TxtTen_chucvu1.Text = ""
        End If
    ...
    End Sub
    Private Sub V_Ma_chucvu2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_chucvu.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_chucvu", "Dmchucvu", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_chucvu2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    ...
    End Sub
    Private Sub V_Ma_BP1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_BP_H1.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BP", "DmBP", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_BP1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_BP_H1.Text = "" Then
            TxtTen_BP_h1.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_BP_H1.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_BP_H1.Text = DrReturn.Item("Ma_BP")
            TxtTen_BP_h1.Text = DrReturn.Item("Ten_BP")
        Else
            TxtMa_BP_H1.Text = ""
            TxtTen_BP_h1.Text = ""
        End If
    ...
    End Sub
    Private Sub V_Ma_BP2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_bp_h.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BP", "DmBP", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_bp2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_bp_h.Text = "" Then
            TxtTen_Bp_h.Text = ""
            Exit Sub
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        Dim n_DiemChuan As Decimal = 0
        Dim n_DanhGia As Decimal = 0
        Dim n_NV_DT As Decimal = 0
        Dim n_NV_CL As Decimal = 0
        Dim n_QL_SLVP As Decimal = 0
        Dim n_QL_DT As Decimal = 0
        Dim n_QL_CL As Decimal = 0


        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            n_DiemChuan = n_DiemChuan + Dv_DetailTmp.Item(iRow).Item("Diem_chuan")
            n_DanhGia = n_DanhGia + Dv_DetailTmp.Item(iRow).Item("Diem_DG")

        Next

        TxtDiem_chuan.Double = n_DiemChuan
        TxtDiem_DG.Double = n_DanhGia
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_chitieu").ToString.Trim = "" Then
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim Ma_GD As String = "", m_ma_xly As String = ""
        Ma_GD = CbbMa_GD.SelectedValue
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_LoadTieu_chi1", M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For i As Integer = 0 To DsTmp.Tables.Count - 1
            CyberSmodb.SetNotNullTable(DsTmp.Tables(i))
        Next
        Dt_DetailTmp.Clear()
