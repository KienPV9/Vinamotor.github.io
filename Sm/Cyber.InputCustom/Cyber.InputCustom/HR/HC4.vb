...
#End Region
    Private Sub HC4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetail(ByVal _Loai As String, ByVal _So As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetHC4", _Loai & "#" & _So & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub Tinh_Gia2(ByVal iRow As Integer)
        ...
        dsGia2 = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHC4Gia2", _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec & "#" & M_Mode & "#" &
