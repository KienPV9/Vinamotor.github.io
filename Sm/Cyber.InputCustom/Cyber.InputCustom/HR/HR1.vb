...
#Region "Columns Edit"
    ...
    Dim EditMuc_luong, EditMuc_luongTT, Editluong_tv, Editluong_Hv, Editphu_cap, EditTG_KyHD, EditNGAY_HETHAN_HV As New Cyber.Fill.CyberColumnGridView
#End Region
#Region "Khai bao bien Private"
    Dim M_Ct, M_Ph As String
    Dim DrReturn As DataRow
    Dim M_Count As Integer = 1
    Dim DtPost, DtMaGD, DtMaCty As DataTable
#End Region
    Private Sub HR1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        DtMaCty = CyberSmodb.OpenTableKey(AppConn, Nothing, "DmCty", "Ma_Cty", "1=1", CyberSmlib)
        ...
        CyberFill.V_FillComBoxValue(Me.cbbMa_Cty, DtMaCty, "Ma_Cty", If(M_LAN = "V", "Ten_Cty", "Ten_Cty"), "")
    ...
    Private Sub V_GetColumn()
        ...
        EditMuc_luong.GetColumn(DetailGRV, "Muc_luong")
        EditMuc_luongTT.GetColumn(DetailGRV, "Muc_luongTT")
        Editluong_tv.GetColumn(DetailGRV, "Luong_TV")
        Editluong_Hv.GetColumn(DetailGRV, "Luong_HV")
        Editphu_cap.GetColumn(DetailGRV, "Phu_cap")
        EditTG_KyHD.GetColumn(DetailGRV, "TG_KyHD")
        EditNGAY_HETHAN_HV.GetColumn(DetailGRV, "NGAY_HETHAN_HV")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        '---
        AddHandler CbbMa_GD.SelectedValueChanged, AddressOf V_Ma_GD
        'AddHandler ButtTaoHD.Click, AddressOf V_TaoHD
    End Sub
    Private Sub V_AddHandler_Master()
        ...
        '-------------------------------------------------------------------------------------
        '--Ma_LoaiBL
        'AddHandler TxtMa_LoaiBL.CyberValiting, AddressOf V_Ma_LoaiBL
        'AddHandler TxtMa_LoaiBL.CyberLeave, AddressOf L_Ma_LoaiBL
        '--Ma_BP_H
        ...
        '--Ma_BacLuong
        'AddHandler TxtMa_BacLuong.CyberValiting, AddressOf V_Ma_BacLuong
        'AddHandler TxtMa_BacLuong.CyberLeave, AddressOf L_Ma_BacLuong
        '--Ma_LoaiHD
        'AddHandler TxtMa_LoaiHD.CyberValiting, AddressOf V_Ma_LoaiHD
        'AddHandler TxtMa_LoaiHD.CyberLeave, AddressOf L_Ma_LoaiHD
        '--Ma_Chucvu
        AddHandler TxtSo_HD_Old.CyberValiting, AddressOf V_So_HD_Old
        AddHandler TxtSo_HD_Old.CyberLeave, AddressOf L_So_HD_Old
    End Sub
    ...
    Private Sub VisibleColumnMa_GD()
        ...
        End Try
        If _Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Then
            '---
            EditMuc_luong.Visible = True
            EditMuc_luongTT.Visible = True
            Editluong_tv.Visible = False
            Editluong_Hv.Visible = False
            Editphu_cap.Visible = False
            EditTG_KyHD.Visible = False
            EditNGAY_HETHAN_HV.Visible = False
            'EditCTMa_Xe_I.Visible = False
        ElseIf _Ma_GD = "4" Then
            Editluong_tv.Visible = True
            Editluong_Hv.Visible = False
            EditMuc_luong.Visible = False
            EditMuc_luongTT.Visible = False
            Editphu_cap.Visible = True
            EditTG_KyHD.Visible = True
            EditNGAY_HETHAN_HV.Visible = False
        ElseIf _Ma_GD = "5" Then
            Editluong_tv.Visible = True
            Editluong_Hv.Visible = False
            EditMuc_luong.Visible = True
            EditMuc_luongTT.Visible = True
        ...
        ElseIf _Ma_GD = "9" Then
            ...
            EditNGAY_HETHAN_HV.Visible = False
        Else
            Editluong_Hv.Visible = True
            Editphu_cap.Visible = False
            EditTG_KyHD.Visible = True
            EditNGAY_HETHAN_HV.Visible = True
            Editluong_tv.Visible = True
            EditMuc_luong.Visible = False
            Editmuc_luongTT.Visible = False
...
#Region "GetHR1"
    Sub V_GetHR1()
        ...
        Dim dsTMp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDefaultHR1", TxtSo_HD_Old.Text.Trim + "#" + M_User_Name + "#" + M_Ma_Dvcs)
        Dim nCount As Integer = dsTMp.Tables.Count
        Dim Dt_Detail As New DataTable
        Dim Dt_Detail1 As New DataTable
        Dt_Detail = dsTMp.Tables(0)
        Dt_Detail1 = dsTMp.Tables(1)
        If Dt_Detail.Rows.Count = 0 Then Exit Sub
        Dt_DetailTmp.Clear()
        CyberSmodb.SQLTbToTb(Dt_Detail, Dt_DetailTmp)
        ...
        If Dt.Rows.Count < 1 Then
            ...
            Exit Sub
        End If
        If Dt.Columns.Contains("Ma_Cty") Then cbbMa_Cty.SelectedValue = Dt.Rows(0).Item("Ma_Cty")
        ...
        If Dt.Columns.Contains("Ma_ChucVu") Then TxtMa_Chucvu.Text = Dt.Rows(0).Item("Ma_ChucVu")
        If Dt.Columns.Contains("Ten_ChucVu") Then TxtTen_Chucvu.Text = Dt.Rows(0).Item("Ten_ChucVu")
        If Dt.Columns.Contains("Ten_HS_H") Then TxtTen_HS_H.Text = Dt.Rows(0).Item("Ten_HS_H")
        If Dt.Columns.Contains("Is_HD_KhongTH") Then ChkIs_HD_KhongTH.Checked = Dt.Rows(0).Item("Is_HD_KhongTH")
        If Dt.Columns.Contains("Ngay_HL1") Then TxtNgay_HL1.Value = Dt.Rows(0).Item("Ngay_HL1")
        If Dt.Columns.Contains("Ngay_HL2") Then TxtNgay_HL2.Value = Dt.Rows(0).Item("Ngay_HL2")
        If Dt.Columns.Contains("TG_LV") Then TxtTG_LV.Text = Dt.Rows(0).Item("TG_LV")
        If Dt.Columns.Contains("Cong_viec") Then txtCong_viec.Text = Dt.Rows(0).Item("Cong_viec")
        If Dt.Columns.Contains("Dien_giai") Then txtDien_giai.Text = Dt.Rows(0).Item("Dien_giai")

        If Dt_Detail1.Rows.Count = 0 Then Exit Sub
        Dt_DetailTmp.Clear()
        CyberSmodb.SQLTbToTb(Dt_Detail1, Dt_DetailTmp)

        Dim Dt1 As DataTable = dsTMp.Tables(1)
        CyberSmodb.SetNotNullTable(Dt)
        '--- Up thong tin
        ...
        Dv_DetailTmp.Item(iRow).Item("Muc_luong") = Dt1.Rows(0).Item("Muc_luong")
        Dv_DetailTmp.Item(iRow).Item("Muc_LuongTT") = Dt1.Rows(0).Item("Muc_LuongTT")
    End Sub
#End Region
#Region "Valid - Master"
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    End Sub
#End Region
#Region "Valid --- Ma_LoaiBL"
    'Private Sub V_Ma_LoaiBL(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    TxtMa_LoaiBL.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_LoaiBL", "DmLoaiBangLuong", "1=1", "1=1")
    'End Sub
    'Private Sub L_Ma_LoaiBL(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    If TxtMa_LoaiBL.Text = "" Then
    '        TxtTen_LoaiBL.Text = ""
    '        Exit Sub
    '    End If
    '    DrReturn = TxtMa_LoaiBL.GetRowsSelectData(True)
    '    If Not DrReturn Is Nothing Then
    '        TxtMa_LoaiBL.Text = DrReturn.Item("Ma_LoaiBL")
    '        TxtTen_LoaiBL.Text = DrReturn.Item("Ten_LoaiBL")
    '    Else
    '        TxtMa_LoaiBL.Text = ""
    '        TxtTen_LoaiBL.Text = ""
    '    End If
...
#Region "Valid --- Ma_HS_H"
    ...
    End Sub
#End Region
#Region "Valid --- Ma_Chucvu"
    Private Sub V_Ma_Chucvu(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_Chucvu.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_Chucvu", "DMChucvu", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Chucvu(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_Chucvu.Text = "" Then
            TxtTen_Chucvu.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_Chucvu.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
        ...
        End If
    End Sub
    Private Sub V_Ma_GD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
...
#End Region
#Region "Valid --- So_HD"
    Private Sub V_So_HD_Old(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtSo_HD_Old.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "So_CT", "DMHDLD", "1=1", "1=1")
    End Sub
    Private Sub L_So_HD_Old(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_HD_Old.Text = "" Then
            Exit Sub
        End If
        DrReturn = TxtSo_HD_Old.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtSo_HD_Old.Text = DrReturn.Item("So_CT")
        Else
            TxtSo_HD_Old.Text = ""
        End If
        V_GetHR1()
    End Sub
#End Region
#Region "Valid --- Ma_BacLuong"
    'Private Sub V_Ma_BacLuong(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    sender.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BacLuong", "DmBacLuong", "1=1", "1=1")
    'End Sub
    'Private Sub L_Ma_BacLuong(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    If TxtMa_BacLuong.Text = "" Then
    '        TxtTen_BacLuong.Text = ""
    '        Exit Sub
    '    End If
    '    DrReturn = TxtMa_BacLuong.GetRowsSelectData(True)
    '    If Not DrReturn Is Nothing Then
    '        TxtMa_BacLuong.Text = DrReturn.Item("Ma_BacLuong")
    '        TxtTen_BacLuong.Text = DrReturn.Item("Ten_BacLuong")
    '    End If
    '    If TxtMa_BacLuong.Text.Trim <> "" Then V_UPDATE_BACLUONG()
    'End Sub
    'Private Sub V_UPDATE_BACLUONG()
    '    Dim nCount As Integer = 0
    '    For i = 0 To Dt_DetailTmp.Rows.Count - 1
    '        If Dt_DetailTmp.Rows(i).Item("Ma_CTLuong").ToString.Trim <> "" Then nCount = nCount + 1
    '    Next
    ...
    '    Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HRUpdateMa_BacLuong", TxtMa_BP_H.Text.Trim & "#" & TxtMa_HS_H.Text & "#" & TxtMa_Chucvu.Text & "#" & TxtMa_LoaiHD.Text & "#" & _Ma_GD & "#" & _Ma_Post & "#" & TxtMa_BacLuong.Text.Trim & "#" & _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    '    End If
    '    '--------------------------------------------------------------------
    '    If DsTmp.Tables(1).Columns.Contains("Ma_LoaiBL") Then TxtMa_LoaiBL.Text = DsTmp.Tables(1).Rows(0).Item("Ma_LoaiBL")
    '    If DsTmp.Tables(1).Columns.Contains("Ten_LoaiBL") Then TxtTen_LoaiBL.Text = DsTmp.Tables(1).Rows(0).Item("Ten_LoaiBL")

    '    If DsTmp.Tables(1).Columns.Contains("Ma_Bp_H") Then TxtMa_BP_H.Text = DsTmp.Tables(1).Rows(0).Item("Ma_BP_H")
    '    If DsTmp.Tables(1).Columns.Contains("Ten_BP_H") Then TxtTen_Bp_H.Text = DsTmp.Tables(1).Rows(0).Item("Ten_BP_H")
    ...
    '    If DsTmp.Tables(1).Columns.Contains("Ma_LoaiHD") Then TxtMa_LoaiHD.Text = DsTmp.Tables(1).Rows(0).Item("Ma_LoaiHD")
    '    If DsTmp.Tables(1).Columns.Contains("Ten_LoaiHD") Then TxtTen_LoaiHD.Text = DsTmp.Tables(1).Rows(0).Item("Ten_LoaiHD")
    ...
    'End Sub
#End Region
#Region "Valid --- Ma_LoaiHD"
    'Private Sub V_Ma_LoaiHD(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    TxtMa_LoaiHD.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_LoaiHD", "DMLoaiHD", "1=1", "1=1")
    'End Sub
    'Private Sub L_Ma_LoaiHD(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '    If TxtMa_LoaiHD.Text = "" Then
    '        TxtTen_LoaiHD.Text = ""
    '        Exit Sub
    '    End If
    '    DrReturn = TxtMa_LoaiHD.GetRowsSelectData(True)
    '    If Not DrReturn Is Nothing Then
    '        TxtMa_LoaiHD.Text = DrReturn.Item("Ma_LoaiHD")
    '        TxtTen_LoaiHD.Text = DrReturn.Item("Ten_LoaiHD")
    '    Else
    '        TxtMa_LoaiHD.Text = ""
    '        TxtTen_LoaiHD.Text = ""
    '    End If
...
#Region "Ma_CTLuong"
    Private Sub V_Ma_CTLuong(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_CTLuong", "DmCTLuong", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_CTLuong(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_CTLuong") = ""
            Dv_DetailTmp.Item(iRow).Item("ten_CTLuong") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_CTLuong") = DrReturn("Ma_CTLuong").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("ten_CTLuong") = DrReturn("ten_CTLuong").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("muc_luong").ToString.Trim = "" Then
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        'TxtMa_LoaiBL.Enabled = False
        'TxtMa_BP_H.Enabled = False
        ' TxtMa_donvi.Enabled = False
        'TxtMa_Chucvu.Enabled = False
        'TxtMa_LoaiHD.Enabled = False
    End Sub
#End Region
