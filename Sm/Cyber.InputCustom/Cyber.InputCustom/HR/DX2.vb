...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editma_chucdanh, editis_nghi, editDiem_KPI, editSL_VP, editDiem_tru, EditNgay_LV, editDiem_con_lai, editSL_VP_QL, editDiem_chuan, editTham_nien As New Cyber.Fill.CyberColumnGridView
#End Region
