...
#End Region
    Private Sub V_Gio_Ra(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim D1, D2 As Date
        D1 = TxtNgay_Ct.Value + " " + TxtGio_ra.Text
        D2 = TxtNgay_Ct.Value + " " + TxtGio_vao.Text

        TxtCong_Lam_Them.Text = CyberSupport.V_Round(DateDiff(DateInterval.Hour.Minute, D2, D1).ToString / (8 * 60), 2)
    End Sub
