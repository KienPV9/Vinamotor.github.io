...
#Region "V_AddHandler"
    ...
    Private Sub VisibleColumnMa_GD()
        If CbbMa_GD.SelectedValue = "1" Then
            LblNgay_NV.Visible = True
            TxtNgay_NV.Visible = True
            '
            LblNgay_BDTS.Visible = False
            txtNgay_BDTS.Visible = False
            LblNgay_KT_TS.Visible = False
            TxtNgay_KTTS.Visible = False
        Else
            LblNgay_NV.Visible = False
            TxtNgay_NV.Visible = False
            '
            LblNgay_BDTS.Visible = True
            txtNgay_BDTS.Visible = True
            LblNgay_KT_TS.Visible = True
            TxtNgay_KTTS.Visible = True
        End If
    End Sub
...
#Region "Valid --- Ma_HS_H"
    ...
    End Sub
#End Region
    '#Region "Valid --- Ma_Hs_K"
    '    Private Sub V_Ma_Hs_K(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '        TxtMa_HS_K.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_HS", "DMHS", "1=1", "1=1")
    '    End Sub
    '    Private Sub L_Ma_HS_K(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '        If TxtMa_HS_K.Text = "" Then
    '            TxtTen_HS_K.Text = ""
    '            Exit Sub
    '        End If
    '        DrReturn = TxtMa_HS_K.GetRowsSelectData(True)
    '        If Not DrReturn Is Nothing Then
    '            TxtMa_HS_K.Text = DrReturn.Item("Ma_HS")
    '            TxtTen_HS_K.Text = DrReturn.Item("Ten_HS")
    '        Else
    '            TxtMa_HS_K.Text = ""
    '            TxtTen_HS_K.Text = ""
    '        End If
