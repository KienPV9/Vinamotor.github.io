...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_Nh_Kx2_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    Dim EditPS_NT, EditPs, EditSo_Luong, EditSl_hang, EditSl_Td_i, EditGia_NT, EditGia, EditTien_NT, EditTien, EditHe_So1, EditGia_NT2, EditGia2, EditTien_NT2, EditTien2, EditGia_NT3, EditGia3, EditTien_NT3, EditTien3, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EditTen_Vt, EditDvt, EditTen_kho_i, EditTen_Tk_VT, EditTen_Nx_I As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_Nh_Kx2, EditTen_Nh_Kx2, EditMa_kx, EditTen_Kx, EditMa_Mau, EditTen_Mau, EditNh_Hs1, EditTen_hs_i, EditTien_thuong_TN, EditPT_1, EditPT_2, EditPT_3, EditTien_1, EditTien_2, EditTien_3, EditTien_4 As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditSl_hang.GetColumn(DetailGRV, "Sl_hang")
        ...
        EditSl_Td_i.GetColumn(DetailGRV, "Sl_Td_i")
        ...
        EditMa_Nh_Kx2.GetColumn(DetailGRV, "Ma_Nh_Kx2")
        EditTen_Nh_Kx2.GetColumn(DetailGRV, "Ten_Nh_Kx2")
        ...
        EditTien_thuong_TN.GetColumn(DetailGRV, "Tien_thuong_TN")
        EditPT_1.GetColumn(DetailGRV, "PT_1")
        EditPT_2.GetColumn(DetailGRV, "PT_2")
        EditPT_3.GetColumn(DetailGRV, "PT_3")
        EditTien_1.GetColumn(DetailGRV, "Tien_1")
        EditTien_2.GetColumn(DetailGRV, "Tien_2")
        EditTien3.GetColumn(DetailGRV, "Tien_3")
        EditTien_4.GetColumn(DetailGRV, "Tien_4")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_Nh_Kx2_I.V_ActiLookUpColumn(AddressOf V_Ma_Nh_Kx2_i, AddressOf L_Ma_Nh_Kx2_i)
        EditMa_Nh_Kx2.V_ActiLookUpColumn(AddressOf V_Ma_Nh_Kx2, AddressOf L_Ma_Nh_Kx2)
        EditMa_kx.V_ActiLookUpColumn(AddressOf V_Ma_kx, AddressOf L_Ma_kx)

        EditNh_Hs1.V_ActiLookUpColumn(AddressOf V_Ma_NHHS, AddressOf L_Ma_NhHS)
    ...
    Private Sub VisibleColumnMa_GD()
        M_Ma_GD = CbbMa_GD.SelectedValue.ToString()
        If M_Ma_GD = "3" Then
            EditTien_NT.Visible = True
            EditMa_Nh_Kx2.Visible = True
            EditTen_Nh_Kx2.Visible = True
            EditSo_Luong.Visible = True
            EditSl_hang.Visible = True
            EditSl_Td_i.Visible = False
            EditTien.Visible = False
            EditHe_So1.Visible = False
            EditNh_Hs1.Visible = False
            EditMa_HS_I.Visible = True
            EditTen_hs_i.Visible = True
            EditTien_thuong_TN.Visible = False

            EditTien_1.Visible = False
            EditTien_2.Visible = False
            EditTien_3.Visible = False
            EditTien_4.Visible = False
        End If
        ...
        If M_Ma_GD = "5" Then
            ...
            EditSo_Luong.Visible = True
            EditSl_hang.Visible = True
            EditMa_Nh_Kx2.Visible = False
            EditTen_Nh_Kx2.Visible = False
            EditSl_Td_i.Visible = False
            EditTien.Visible = False
            EditHe_So1.Visible = False
            EditMa_HS_I.Visible = True
        ...
        If M_Ma_GD = "6" Then
            ...
            EditSl_Td_i.Visible = True
            EditSo_Luong.Visible = False
            EditSl_hang.Visible = False
            EditMa_Nh_Kx2.Visible = False
            EditTen_Nh_Kx2.Visible = False
        End If
        If M_Ma_GD = "7" Then
        ...
        If M_Ma_GD = "8" Then
            ...
            EditNh_Hs1.Visible = True
            EditMa_kx.Visible = True
            EditTen_Kx.Visible = True
            EditTien_thuong_TN.Visible = False
        ...
        If M_Ma_GD = "9" Then
            ...
            EditMa_HS_I.Visible = True
            EditTen_hs_i.Visible = True
            EditMa_kx.Visible = False
            EditTen_Kx.Visible = False
            EditTien_thuong_TN.Visible = False
            EditTien_1.Visible = True
            EditTien_2.Visible = True
            EditTien_4.Visible = True
...
#Region "Valid - Detail - Add On"
    ...
    End Sub
    Private Sub V_Ma_Nh_Kx2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Nh", "DmNhkx", "Loai_Nh =N'2'", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Nh_Kx2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If drReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRows)("Ma_Nh_Kx2") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Ma_Nh_Kx2") = drReturn("Ma_Nh").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_Nh_KX2") = drReturn("Ten_Nh").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
    ...
    Private Sub V_Ma_NHHS(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Nh", "DMNHHS", "Loai_Nh =N'5'", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_NhHS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim iRows As Integer = -1
        Dim drReturn As DataRow
        iRows = DetailGRV.FocusedRowHandle
        If iRows < 0 Then Exit Sub
        drReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If drReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRows)("NH_HS1") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("NH_HS1") = drReturn("Ma_Nh").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
    ...
    Private Sub L_Ma_Mau(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DetailGRV.UpdateCurrentRow()
    End Sub
    Private Sub V_Ma_Nh_Kx2_i(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Kx_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Nh_Kx2_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        '    If Dt_DetailTmp.Rows(iRow).Item("Nh_Kx").ToString.Trim = "" Then
