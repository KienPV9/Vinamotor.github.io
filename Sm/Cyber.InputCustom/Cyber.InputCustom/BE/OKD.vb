...
#Region "Columns Edit"
    ...
    Dim EditMa_Nh_Kx2, EditTen_Nh_Kx2, EditMa_Mau, EditTen_Mau, EditNh_Hs1, EditTen_Nh_Hs1 As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditTen_Nh_Hs1.GetColumn(DetailGRV, "TEN_NH_HS1")
    End Sub
...
#End Region
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtMa_Bp_H.Text.Trim = "" Then
            ...
            Exit Sub
        Else
            Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDmHs_OKD", M_Stt_Rec & "#" & M_Ma_CT & "#" & TxtMa_Bp_H.Text & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_NhHS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If drReturn Is Nothing Then
            ...
            Dt_DetailTmp.Rows(iRows)("Ten_NH_HS1") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("NH_HS1") = drReturn("Ma_Nh").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_NH_HS1") = drReturn("Ten_nh").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
