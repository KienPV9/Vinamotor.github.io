...
Public Class FrmPrintVoucherPBG
    ...
    Private Sub FrmPrintVoucherPBG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
    ...
    Private Sub GetTable()
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_LoadSTT_Rec0", "PBG" & "#" & CbbMa_In.SelectedValue.ToString.Trim & "#" & Stt_Rec.ToString.Trim & "#" & M_User_name)
        DtStt_rec0 = _DsTmp.Tables(0)
        '--- Combobox
        CyberFill.V_FillComBoxDefaul(CbbSttRec0, DtStt_rec0, "Ma", "Ten")
    ...
    Private Sub V_Print(ByVal _Status)
        ...
        Me.Key_Sub1 = CbbSttRec0.SelectedValue.ToString
        Me.ReturnOk = True
