...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler Txtma_ctkm.CyberValiting, AddressOf V_Ma_ct
        AddHandler Txtma_ctkm.CyberLeave, AddressOf L_Ma_ct
...
#Region "Valid --- Ma_Hs_H"
    ...
    Private Sub V_Ma_ct(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Txtma_ctkm.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_ct", "Dmctkm", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_ct(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Txtma_ctkm.Text = "" Then
            TxtTen_ctkm.Text = ""
            Exit Sub
        End If
        DrReturn = Txtma_ctkm.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            Txtma_ctkm.Text = DrReturn.Item("Ma_ct")
            TxtTen_ctkm.Text = DrReturn.Item("Ten_ct")
        Else
            Txtma_ctkm.Text = ""
            TxtTen_ctkm.Text = ""
        End If
