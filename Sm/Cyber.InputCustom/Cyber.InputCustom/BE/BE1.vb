...
#End Region
#Region "Columns Edit"
    Dim EditNh_Hs1, EditMa_Td3, EditMa_KH, EditMa_KX, EditNgay_XHD, EditNgay_Coc, EditMa_Hs, EditTien_TVBH, EditTien_TPBH, EditT_TT, EditDien_Giaii As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_LoadNam()
        ...
        _Return.Columns.Add("Qui")
        _Return.Columns.Add("Ten_Qui")
        _Return.Columns.Add("Ten_Qui2")
        ...
        For i As Integer = 1 To 4
            ...
            If i = 1 Then _Default = "1"
            _Return.Rows.Add(_Thang.ToString, _Thang, _Thang, _Default)
        Next
        CyberFill.V_FillComBoxDefaul(Me.CmbQui, _Return, "Qui", "Ten_Qui", "Default")
    ...
    Private Sub V_GetColumn()
        ...
        EditNgay_XHD.GetColumn(DetailGRV, "Ngay_XHD")
        EditNgay_Coc.GetColumn(DetailGRV, "Ngay_Coc")
        EditTien_TVBH.GetColumn(DetailGRV, "Tien_TVBH")
        EditTien_TPBH.GetColumn(DetailGRV, "Tien_TPBH")
        EditT_TT.GetColumn(DetailGRV, "T")
...
#Region "V_AddHandler"
    ...
    Private Sub VisibleColumnMa_GD()
        If CmbMa_GD.SelectedValue.ToString.Trim = "1" Then
            LblQui.Visible = False
            CmbQui.Visible = False
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim N_T_TVBH As Decimal = 0
        Dim n_T_GDKD As Decimal = 0
        Dim n_T_TT As Decimal = 0
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            N_T_TVBH = N_T_TVBH + Dv_DetailTmp.Item(iRow).Item("Tien_Thuong")
            n_T_GDKD = n_T_GDKD + Dv_DetailTmp.Item(iRow).Item("Tien_TPBH")
        Next
        N_Tong_Tien = N_T_TVBH + n_T_GDKD
    ...
    Private Sub L_Tinh_Toan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("T_TT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_TVBH") + Dv_DetailTmp.Item(iRow).Item("Tien_TPBH"), 0)
    ...
    Private Sub V_TTHopDong(ByVal iRow As Integer)
        ...
        Dim _Ma_Td3 As String = Dv_DetailTmp.Item(iRow).Item("Ma_Td3").ToString.Trim()

        CyberSmodb.GetValueData(Dv_DetailTmp.Item(iRow), _strF, _strV, "Ten_KH,Ten_HS")
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetTTCSBH", _Ma_Td3.Trim + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + M_Mode + "#" + _strF + "#" + _strV + "#" + TxtMa_Dvcs.Text + "#" + M_User_Name)
...
#Region "Valid - Detail - Add On"
    Private Sub V_Nh_Hs1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Nh", "DmNhHs", "1=1", "Loai_Nh=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Nh_Hs1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            If Dv_DetailTmp.Item(iRow).Item("Nh_Hs1").ToString.Trim = "" Then
                Exit Sub
            End If
            Exit Sub
        End If
    ...
    Private Sub L_Ma_Td3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            If Dv_DetailTmp.Item(iRow).Item("Ma_Td3").ToString.Trim = "" Then
                Exit Sub
            End If
            Exit Sub
        End If
        ...
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Td3") = DrReturn("Ma_Td3").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    ...
    Private Sub L_Ma_HS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        If DrReturn Is Nothing Then
            If Dv_DetailTmp.Item(iRow).Item("Ma_HS") = "" Then
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("Ma_Dvcs") = M_Ma_Dvcs
            Dt_DetailTmp.Rows(iRow).Item("Nam") = cmbnam.SelectedValue
            Dt_DetailTmp.Rows(iRow).Item("Qui") = CmbQui.SelectedValue
            Dt_DetailTmp.Rows(iRow).Item("Thang") = cmbThang.SelectedValue
