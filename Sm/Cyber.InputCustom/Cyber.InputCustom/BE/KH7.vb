...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_kh_I, editid_kh, EditMa_HS_I, editma_chucvu, editma_chucdanh, editis_nghi, editTham_nien, editSL_VP, editDiem_tru, editDiem_con_lai, editSL_VP_QL, editDiem_chuan, editDiem_DG As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        Editid_kh.GetColumn(DetailGRV, "id_kh")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        Editid_KH.V_ActiLookUpColumn(AddressOf V_id_Kh, AddressOf L_id_kh)
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub V_Ma_Hs_i(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        'Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_DeXuatTL", M_Ma_HS_H & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub L_Ma_Hs_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("Ngay_LV") = DrReturn("Ngay_LV")
        'Dv_DetailTmp.Item(iRow).Item("Muc_luong") = DrReturn("Muc_luong")
    ...
    Private Sub L_Ma_chucvu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Table.AcceptChanges()
    End Sub
    Private Sub V_id_kh(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("id_KH", "CRQLKHTN", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub

    Private Sub L_id_kh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        DrReturn = Nothing
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        Dim iRow As Integer = -1
        ...
        If iRow < 0 Then Exit Sub
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("id_kh") = DrReturn("id_kh")
        Dv_DetailTmp.Item(iRow).Item("ten_KH") = DrReturn("Ten_kh")
        Dv_DetailTmp.Item(iRow).Item("Ong_ba") = DrReturn("Ong_ba")
        Dv_DetailTmp.Item(iRow).Item("Dia_chi") = DrReturn("Dia_chi")
        Dv_DetailTmp.Item(iRow).Item("Dien_thoai") = DrReturn("Dt1")
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("id_KH").ToString.Trim = "" Then
