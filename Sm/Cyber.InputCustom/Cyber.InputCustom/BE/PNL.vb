...
#Region "Columns Edit"
    ...
    Dim EditMa_VT, EditMa_Xe, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_phi_i, EditMa_HD_I, EditMa_Sp_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditTen_Vt, EditSo_khung, EditMa_kx, EditMa_Mau, EditTen_Nx_I, EditTen_Tk_VT, EditTen_kho_i, EditDvt, EditSo_Luong, EditSo_Luong_HD, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub PNL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_Xe.GetColumn(DetailGRV, "Ma_Xe")
        ...
        EditSo_Luong_HD.GetColumn(DetailGRV, "So_Luong_HD")
    ...
    Private Sub V_SetFocus(ByVal _Loai As String)
        ...
        Select Case _Loai
            Case "M"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtMa_Td3_H.Focus()
            Case "S"
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        'EditSo_khung.V_ActiLookUpColumn(AddressOf V_so_khung, AddressOf L_so_khung)
    ...
    Private Sub VisibleColumnMa_GD()
        ...
        End Try
        If _Ma_GD = "4" Then
            LblMa_Td3_H.Visible = True
            TxtMa_Td3_H.Visible = True
            TxtStt_rec0_td3.Visible = True
            LabMa_HD_H.Visible = True
            TxtMa_HD_H.Visible = True
            TxtTen_HD_H.Visible = True
            'EditSo_Luong.ColumnReadOnly = True
        Else
            LblMa_Td3_H.Visible = False
            TxtMa_Td3_H.Visible = False
            TxtStt_rec0_td3.Visible = False
            LabMa_HD_H.Visible = False
            TxtMa_HD_H.Visible = False
            TxtTen_HD_H.Visible = False
            'EditSo_Luong.ColumnReadOnly = False
        End If
    End Sub
...
#Region "Valid --- Ma_td3"
    ...
    Private Sub L_Ma_td3_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        Else
            ...
            TxtTen_HD_H.Text = ""
        End If
        V_GetDetailPNL(TxtMa_Td3_H.Text)
    End Sub
    Private Sub V_GetDetailPNL(ByVal _Ma_TD3 As String)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If _Ma_TD3.Trim = "" Then Exit Sub
        Dim DsTmp As New DataSet
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailPNL", _Ma_TD3 & "#" & M_Ma_Dvcs.ToString().Trim() & "#" & M_User_Name.ToString().Trim())
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_RO.Text = CyberVoucher.V_GetSo_Ro(M_Ma_CT, "S", M_Mode, _Dt, TxtLenh_RO.Text, TxtMa_Dvcs.Text)
    End Sub
...
#Region "Valid - Detail - Core"
    ...
    Private Sub L_Tinh_Toan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'hieulv 
        If CbbMa_GD.SelectedValue.ToString.Trim = "4" Then
            Dv_DetailTmp.Item(iRow).Item("So_Luong") = Dv_DetailTmp.Item(iRow).Item("So_Luong_HD")
            Exit Sub
        End If
...
#End Region
#Region "So_khung"
    Private Sub V_So_khung(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("So_Khung", "DmSoKhungNhapXe", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_So_Khung(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            If Dv_DetailTmp.Item(iRow).Item("So_Khung").ToString.Trim = "" Then
        ...
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("So_Khung") = DrReturn("So_Khung").ToString.Trim
        If Dv_DetailTmp.Table.Columns.Contains("Ma_kx") And DrReturn.Table.Columns.Contains("Ma_kx") Then Dv_DetailTmp.Item(iRow).Item("Ma_kx") = DrReturn("Ma_kx").ToString.Trim
        If Dv_DetailTmp.Table.Columns.Contains("Ma_Mau") And DrReturn.Table.Columns.Contains("Ma_Mau") Then Dv_DetailTmp.Item(iRow).Item("Ma_Mau") = DrReturn("Ma_Mau").ToString.Trim
        If Dv_DetailTmp.Table.Columns.Contains("Ma_kho_i") And DrReturn.Table.Columns.Contains("Ma_kho_i") Then Dv_DetailTmp.Item(iRow).Item("Ma_kho_i") = DrReturn("Ma_kho_i").ToString.Trim
        If Dv_DetailTmp.Table.Columns.Contains("So_luong") And DrReturn.Table.Columns.Contains("So_luong") Then Dv_DetailTmp.Item(iRow).Item("So_luong") = DrReturn("So_luong").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
        V_SetSD(iRow)
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_Ma_Vt(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Vt", "dmvt", "Nh_Vt1='QT'", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    ...
    Private Sub V_Ma_Xe(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Xe(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Xe(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        DrReturn = Nothing
        DrReturn = CyberSupport.L_Ma_Xe(M_Mode, M_Ma_CT, sender, DetailGRV)
        Dim iRow As Integer = -1
        If DrReturn Is Nothing Then
            Exit Sub
        End If
        ...
        If iRow < 0 Then Exit Sub
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Xe") = DrReturn.Item("Ma_Xe")
        Dv_DetailTmp.Item(iRow).Item("So_khung") = DrReturn.Item("So_khung")
...
#Region "So_So/So_PO/So_RO/So_VT"
    ...
    Private Sub L_So_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'If Dt_DetailTmp.Columns.Contains("So_Ro") Then Dv_DetailTmp.Item(iRow).Item("So_RO") = CyberVoucher.V_GetSo_RO(M_Ma_CT, "S", M_Mode, _Ngay_Ct, Dv_DetailTmp.Item(iRow).Item("So_RO"), M_Ma_Dvcs)
...
#Region "Button"
    ...
    Private Sub V_GetMaBP()
        ...
        If dsTMp.Tables(0).Columns.Contains("Ten_Bp_H") Then If TxtTen_bp.Text.Trim = "" Then TxtTen_bp.Text = dsTMp.Tables(0).Rows(0).Item("Ten_Bp_H")
        If dsTMp.Tables(0).Columns.Contains("Ten_Hs_H") Then If txtOng_ba.Text.Trim = "" Then txtOng_ba.Text = dsTMp.Tables(0).Rows(0).Item("Ten_Hs_H")
        dsTMp.Dispose()
    End Sub
    Private Sub V_New()
