...
#Region "Columns Edit"
    ...
    Dim EditTen_Kx, EditTen_Mau, EditDvt, EditTen_Kho_i, EditTen_Tk_Vt, EditSo_Luong, EditGia_NT0, EditGia0, EditGia_NT, EditTien_Nt0, EditTien0, EditCP_NT, EditCP, EditGia, EditTien_Nt, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT, EditMa_mau_nt As New Cyber.Fill.CyberColumnGridView
#End Region
