...
#End Region
#Region "Columns Edit"
    Dim EditMa_HD, EditMa_Td3, EditMa_KH, EditMa_KX, EditNgay_XHD, EditNgay_Coc, EditMa_Hs, EditTien_TVBH, EditTien_TPBH, EditT_TT, EditDien_Giaii As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            N_T_TVBH = N_T_TVBH + Dv_DetailTmp.Item(iRow).Item("Tien_TVBH")
