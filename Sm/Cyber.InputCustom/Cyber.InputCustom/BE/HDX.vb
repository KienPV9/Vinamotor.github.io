...
#Region "Columns Edit"
    ...
    Dim EditMa_Mau_Nt, EditTen_Mau_Nt, EditKM_PK_VNMT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditKM_PK_VNMT.Column Is Nothing Then AddHandler EditKM_PK_VNMT.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "So bao gia"
    ...
    Private Sub L_So_BG(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DsPBG.Tables(1).Columns.Contains("Ngay_CMT_KH") And DsPBG.Tables(1).Rows(0).Item("Ngay_CMT_KH").ToString("yyyyMMdd") <> "19000101" Then TxtNgay_CMT.Value = DsPBG.Tables(1).Rows(0).Item("Ngay_CMT_KH")
        If DsPBG.Tables(1).Columns.Contains("Noi_Cap_Cmt_Kh") And TxtNoi_Cap_Cmt.Text.Trim = "" Then TxtNoi_Cap_Cmt.Text = DsPBG.Tables(1).Rows(0).Item("Noi_Cap_Cmt_Kh")
...
#Region "Valid --- Id_kh"
    ...
    Private Sub V_Get_Id_kh()
        ...
        If DsKHTN.Tables(1).Columns.Contains("Ngay_CMT_KH") And _Dt_CMT.ToString("yyyyMMdd") = "19000101" Then TxtNgay_CMT.Value = DsKHTN.Tables(1).Rows(0).Item("Ngay_CMT_KH")
        ...
        If DsKHTN.Tables(1).Columns.Contains("Stk_kh") And TxtStk_kh.Text.Trim = "" Then TxtStk_kh.Text = DsKHTN.Tables(1).Rows(0).Item("Stk_kh")
        If DsKHTN.Tables(1).Columns.Contains("ChiNhanhNh_Kh") And TxtChiNhanhNh_Kh.Text.Trim = "" Then TxtChiNhanhNh_Kh.Text = DsKHTN.Tables(1).Rows(0).Item("ChiNhanhNh_Kh")
        '------------------------------------------------------------------------------------------------------------------------------------------
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dt_DetailTmp.Columns.Contains("Gg_CS") And Dt_DetailTmp.Columns.Contains("Vuot_Khung") Then
            Dv_DetailTmp.Item(iRow).Item("Vuot_Khung") = Dv_DetailTmp.Item(iRow).Item("Ck") + Dv_DetailTmp.Item(iRow).Item("Km_PK") + Dv_DetailTmp.Item(iRow).Item("KM_PK_VNMT") + Dv_DetailTmp.Item(iRow).Item("Km_BH") + Dv_DetailTmp.Item(iRow).Item("Moi_gioi") + Dv_DetailTmp.Item(iRow).Item("Km_khac") - Dv_DetailTmp.Item(iRow).Item("Gg_CS")
        End If
        '---- 
        Dv_DetailTmp.Item(iRow).EndEdit()
        '----------------------------------------------------------------------------------------------
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetPriceXeSales_Luu(ByVal iRow As Integer)
        ...
        If _DtGia.Columns.Contains("KM_PK_VNMT") And Dt_DetailTmp.Columns.Contains("KM_PK_VNMT") Then Dv_DetailTmp.Item(iRow).Item("KM_PK_VNMT") = _DtGia.Rows(0).Item("KM_PK_VNMT")
...
#Region "Button"
    ...
    Private Sub V_GetNoMa_HDVoucherAuto(ByRef strField As String, ByRef strValue As String)
        ...
        If DsGet.Tables(1).Columns.Contains("Ma_HD_H") And TxtMa_HD_KH.Text = "" Then TxtMa_HD_KH.Text = DsGet.Tables(1).Rows(0).Item("Ma_HD_H").ToString.Trim
    End Sub
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        If M_Ma_Dvcs <> "20" Then
            LbNgay_HopDong.Visible = False
            TxtNgay_Hop_Dong.Visible = False
        End If
    End Sub
#End Region
#Region "E Mail And Approval/Print Ho so"
    ...
    Private Sub V_Phu_Kien(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode = "M" Or M_Mode = "S" Then Return
        If M_Stt_Rec.Trim = "" Then Return
        Dim _Ma_HD_H As String = TxtMa_HD_H.Text.Trim + ".0001"
        If _Ma_HD_H.Trim = "" Then Return

        Dim strAddParar As String = "1#BPK#" & _Ma_HD_H & "#"
        If M_Ma_Dvcs = "20" Then
            _Ma_HD_H = TxtMa_HD_H.Text.Trim
            strAddParar = "4#PPK#" & _Ma_HD_H & "#"
        End If
