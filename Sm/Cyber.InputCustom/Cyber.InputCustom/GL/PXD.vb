...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        M_Ver = M_Para(M_VT_PARA + 4).Trim '-- SONNT: phân biệt bản thuế hay bản NB
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'Biển số
        AddHandler TxtMa_Xe.Leave, AddressOf V_Ma_Xe_i2In4
    End Sub
...
#End Region
#End Region
#Region "lấy thông tin từ biển số"
    Private Sub V_Ma_Xe_i2In4(ByVal sender As Object, ByVal e As System.EventArgs)

        If Not (M_Mode = "M" Or M_Mode = "S") Or TxtMa_Xe.Text = "" Then Exit Sub

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDataPxdFromMaxe", TxtMa_Xe.Text & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        ' 
        TxtDia_Chi.Text = DsTmp.Tables(0).Rows(0).Item("dia_chi").ToString.Trim
        txtOng_ba.Text = DsTmp.Tables(0).Rows(0).Item("Ong_ba").ToString.Trim
        ' --
        TxtMa_Kh.Text = DsTmp.Tables(0).Rows(0).Item("Ma_KH").ToString.Trim
        TxtTen_kh.Text = DsTmp.Tables(0).Rows(0).Item("ten_kh").ToString.Trim
    End Sub
#End Region
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Tk_621 As String = DrReturn.Item("Tk_621")
        ...
        If M_Ver = "VAT" Then
            Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I").ToString.Trim = "", _Tk_621, Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I").ToString.Trim)
        Else
        ...
        If CbbMa_GD.SelectedValue = "1" Then
            Dv_DetailTmp.Item(iRow).Item("MA_NX_I") = _Tk_Gv
        End If
        ...
        Dv_DetailTmp.Item(iRow).Item("Ma_kho_I") = _Ma_kho
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
...
#Region "Sms - Import"
    Private Sub V_Import(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dt_DetailTmp.AcceptChanges()
        CyberSmodb.V_CyberBulkSaveToSQL(AppConn, osysvar, M_User_Name, Dt_DetailTmp, "Import_HTN", M_Mode, "1=1", True)

        '2. Lay tu table DMS ra do vao Grid
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_getimport", M_Stt_Rec & "#" & M_Ma_CT.Trim & "#" & TxtMa_Dvcs.Text.Trim & "#" & M_User_Name & "#" & CbbMa_GD.SelectedValue)
        For i As Integer = 0 To DsTmp.Tables.Count - 1
            CyberSmodb.SetNotNullTable(DsTmp.Tables(i))
        Next
