...
#End Region
#Region "Columns Edit"
    Dim EditTk_i, EditMa_kh_I, EditMa_kh_C As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    Dim EditMa_TT, EditMa_VT, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_phi_i, EditMa_HD_I, EditMa_Sp_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView 'New Cyber.SmLists.EditLookUp
    ...
    Dim EditTEN_TK_I, EditTEN_KH_I, EditTEN_KH_C, EditSo_hd, EditNgay_HD, EditTien_Hd, EditTien_Hd_NT, EditDa_PB, EditDa_PB_NT, EditCL_PB, EditCl_Pb_NT, EditTy_Gia_HT, EditCotCuoi As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
    Private Sub BN1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub L_Ma_KH_C(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Ma_Kh_C").ToString.Trim = "" Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Kh_C") = Dv_DetailTmp.Item(iRow).Item("Ma_Kh_C")
            Dv_DetailTmp.Item(iRow).EndEdit()
            Dv_DetailTmp.Table.AcceptChanges()
        End If
    End Sub
