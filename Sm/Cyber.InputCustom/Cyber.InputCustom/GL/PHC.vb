...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler ChkIs_CK.CheckedChanged, AddressOf V_Chuyen_Khoan
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub L_Ma_GD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        VisibleColumnMa_GD()
    End Sub
    Private Sub V_Chuyen_Khoan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
...
#Region "SODNTT"
    Private Sub V_Ma_DNTT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtSoDNTT_OLD.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "so_ct", "DmSoDNTTPHC", "1=1", "1=1")
    End Sub
...
#Region "Button"
    ...
    Private Function V_ChkDelete() As Boolean
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkDeletePHC", M_Stt_Rec + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
