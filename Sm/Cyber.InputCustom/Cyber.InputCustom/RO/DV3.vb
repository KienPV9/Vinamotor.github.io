...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editma_chucdanh, editis_nghi, editTham_nien, edithe_so_TT, editTien_thuong, editTy_le, editKPIs, EditHe_so_thuong, editDiem_thuong As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GETCTBP_DV_01", M_Stt_Rec & "#" & TxtNgay_Ct.Value & "#" & cmbNam.SelectedValue & "#" & cmdthang.SelectedValue & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
