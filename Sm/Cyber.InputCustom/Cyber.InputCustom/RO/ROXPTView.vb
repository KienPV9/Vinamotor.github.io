...
Public Class ROXPTView
    ...
    Private Sub MasterGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "làm tươi dữ liệu", "Reresh"), AddressOf V_ReFresh, Shortcut.CtrlF5, Me.BackgroundImage, True, True)).BeginGroup = True
        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Quay ra", "Exit"), AddressOf V_Exit, Me.BackgroundImage, True, True)).BeginGroup = True
    ...
    Private Sub Binding_PositionChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            End If
            If (Not String.IsNullOrEmpty(selectedRow("so_ct").ToString)) Then

                filter = "stt_rec='" + selectedRow("so_ct").ToString() + "'"
