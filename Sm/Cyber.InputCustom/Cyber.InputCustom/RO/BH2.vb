...
#Region "Columns Edit"
    ...
    Dim EditTen_HS_I, EditSo_Luong, EditTien, EditPT_TVDat, EditPT_TV_KhongDat, EditPT_PKT, EditPT_NVCT As New Cyber.Fill.CyberColumnGridView
    'Phụ kiện
    Dim EditPT_GD, EditPT_TLPK, Editso_luong_VCX, Editso_luong_TNDS, EditPT_TV_KhongDat_Ngoai, Editso_luong_HVN, Editso_luong_ngoai_HVN, EditPT_TVDat_Ngoai As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditPT_TV_KhongDat.GetColumn(DetailGRV, "PT_TV_KhongDat")
        EditPT_TVDat.GetColumn(DetailGRV, "PT_TVDat")
        EditPT_TLPK.GetColumn(DetailGRV, "PT_TLPK")
        EditPT_PKT.GetColumn(DetailGRV, "PT_PKT")
        EditPT_GD.GetColumn(DetailGRV, "PT_GD")
        EditPT_NVCT.GetColumn(DetailGRV, "PT_NVCT")
        Editso_luong_VCX.GetColumn(DetailGRV, "so_luong_VCX")
        Editso_luong_TNDS.GetColumn(DetailGRV, "so_luong_TNDS")
        EditPT_TV_KhongDat_Ngoai.GetColumn(DetailGRV, "PT_TV_KhongDat_Ngoai")
        Editso_luong_HVN.GetColumn(DetailGRV, "so_luong_HVN")
        Editso_luong_ngoai_HVN.GetColumn(DetailGRV, "so_luong_ngoai_HVN")
        EditPT_TVDat_Ngoai.GetColumn(DetailGRV, "PT_TVDat_Ngoai")
...
#Region "V_AddHandler"
    ...
    Private Sub VisibleColumnMa_GD()
        ...
        EditPT_GD.Visible = False
        EditPT_NVCT.Visible = False
        EditPT_PKT.Visible = False
        EditPT_TLPK.Visible = False
        EditPT_TVDat.Visible = False
        EditPT_TV_KhongDat.Visible = False
        Editso_luong_VCX.Visible = False
        Editso_luong_TNDS.Visible = False
        EditPT_TVDat_Ngoai.Visible = False
        Editso_luong_ngoai_HVN.Visible = False
        Editso_luong_HVN.Visible = False
        EditPT_TV_KhongDat_Ngoai.Visible = False
        ' Set Visible của control theo thủ tục
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SetVisible_BH2", _Ma_GD & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For i As Integer = 0 To DsTmp.Tables(0).Rows.Count - 1
            ...
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditTien" Then EditTien.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_GD" Then EditPT_GD.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_NVCT" Then EditPT_NVCT.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_PKT" Then EditPT_PKT.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_TLPK" Then EditPT_TLPK.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_TVDat" Then EditPT_TVDat.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_TV_KhongDat" Then EditPT_TV_KhongDat.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "Editso_luong_TNDS" Then Editso_luong_TNDS.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "Editso_luong_VCX" Then Editso_luong_VCX.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")

            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_TV_KhongDat_Ngoai" Then EditPT_TV_KhongDat_Ngoai.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "Editso_luong_HVN" Then Editso_luong_HVN.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "Editso_luong_ngoai_HVN" Then Editso_luong_ngoai_HVN.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
            If DsTmp.Tables(0).Rows(i).Item("Ten_Control") = "EditPT_TVDat_Ngoai" Then EditPT_TVDat_Ngoai.Visible = DsTmp.Tables(0).Rows(i).Item("IsVisible")
...
#Region "Valid --- Ma_BP_H"
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _Ngay_ct As Date = TxtNgay_Ct.Value
        Dim _Ma_GD1 As String = CbbMa_GD.SelectedValue
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetTVBH", M_Stt_Rec & "#" & M_Ma_CT & "#" & _Ngay_ct.ToString("yyyyMMdd") & "#" & _Ma_GD1.ToString.Trim & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For i As Integer = 0 To DsTmp.Tables.Count - 1
            CyberSmodb.SetNotNullTable(DsTmp.Tables(i))
        Next
        Dt_DetailTmp.Clear()
...
#Region "Button"
    ...
    Private Sub LabDia_Chi_Click(sender As Object, e As EventArgs) Handles LabDia_Chi.Click

    End Sub

    Private Sub TxtDien_Giai_TextChanged(sender As Object, e As EventArgs) Handles TxtDien_Giai.TextChanged
