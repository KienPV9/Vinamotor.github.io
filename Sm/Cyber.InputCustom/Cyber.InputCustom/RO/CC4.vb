...
#Region "Columns Edit"
    ...
    Dim EditTien_hoa_hong_TNDS, EditTien_hoa_hong_VCX, EditTien_MG, EditTien_tru, EditLUONG_50_50, EditLUONG_KD, EditLUONG_PHAT_NHOM, EditLUONG_THUONG_PHAT, EditTIEN_THUONG_SALE As New Cyber.Fill.CyberColumnGridView
...
#Region "Load And Set And Default"
    ...
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If (M_Mode <> "M" And M_Mode <> "S") Then
            Exit Sub
        End If
        Dim DsTmp1 As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Get_TKinhdoanh", cmbNam.SelectedValue & "#" & cmdthang.SelectedValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For i As Integer = 0 To DsTmp1.Tables.Count - 1
            CyberSmodb.SetNotNullTable(DsTmp1.Tables(i))
        Next
        Dt_DetailTmp.Clear()
        CyberSmodb.SQLTbToTb(DsTmp1.Tables(0), Dt_DetailTmp)
    ...
    Private Sub V_GetColumn()
        ...
        EditTien_hoa_hong_TNDS.GetColumn(DetailGRV, "Tien_hoa_hong_TNDS")
        EditTien_hoa_hong_VCX.GetColumn(DetailGRV, "Tien_hoa_hong_VCX")
        EditTien_MG.GetColumn(DetailGRV, "Tien_MG")
        EditTien_tru.GetColumn(DetailGRV, "Tien_tru")
        EditLUONG_50_50.GetColumn(DetailGRV, "LUONG_50_50")
        EditLUONG_KD.GetColumn(DetailGRV, "LUONG_KD")
        EditLUONG_PHAT_NHOM.GetColumn(DetailGRV, "LUONG_PHAT_NHOM")
        EditLUONG_THUONG_PHAT.GetColumn(DetailGRV, "LUONG_THUONG_PHAT")
        EditTIEN_THUONG_SALE.GetColumn(DetailGRV, "TIEN_THUONG_SALE")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        'If Not EditTien_hoa_hong_TNDS.Column Is Nothing Then AddHandler EditTien_hoa_hong_TNDS.EditColumn.Leave, AddressOf L_Tinh_Toan
        'If Not EditTien_hoa_hong_VCX.Column Is Nothing Then AddHandler EditTien_hoa_hong_VCX.EditColumn.Leave, AddressOf L_Tinh_Toan
        'If Not EditTien_MG.Column Is Nothing Then AddHandler EditTien_MG.EditColumn.Leave, AddressOf L_Tinh_Toan
        'If Not EditTien_tru.Column Is Nothing Then AddHandler EditTien_tru.EditColumn.Leave, AddressOf L_Tinh_Toan

        If Not EditLUONG_50_50.Column Is Nothing Then AddHandler EditLUONG_50_50.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLUONG_KD.Column Is Nothing Then AddHandler EditLUONG_KD.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLUONG_PHAT_NHOM.Column Is Nothing Then AddHandler EditLUONG_PHAT_NHOM.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLUONG_THUONG_PHAT.Column Is Nothing Then AddHandler EditLUONG_THUONG_PHAT.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditTIEN_THUONG_SALE.Column Is Nothing Then AddHandler EditTIEN_THUONG_SALE.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim n_t_HH_TVBH As Decimal = 0, nt_phat_ct As Decimal = 0, nt_HH_KD As Decimal = 0, nt_luong_sale As Decimal = 0, nTong_luong As Decimal = 0, nt_luong_50 As Decimal = 0
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            Dv_DetailTmp.Item(iRow).BeginEdit()
            n_t_HH_TVBH = n_t_HH_TVBH + Dv_DetailTmp.Item(iRow).Item("LUONG_KD")
            nt_phat_ct = nt_phat_ct + Dv_DetailTmp.Item(iRow).Item("LUONG_PHAT_NHOM")
            nt_HH_KD = nt_HH_KD + Dv_DetailTmp.Item(iRow).Item("LUONG_THUONG_PHAT")
            nt_luong_50 = nt_luong_50 + Dv_DetailTmp.Item(iRow).Item("LUONG_50_50")
            nt_luong_sale = nt_luong_sale + Dv_DetailTmp.Item(iRow).Item("TIEN_THUONG_SALE")
            Dv_DetailTmp.Item(iRow).Item("Tien_thuong") = Dv_DetailTmp.Item(iRow).Item("LUONG_KD") + Dv_DetailTmp.Item(iRow).Item("LUONG_PHAT_NHOM") + Dv_DetailTmp.Item(iRow).Item("LUONG_THUONG_PHAT") + Dv_DetailTmp.Item(iRow).Item("LUONG_50_50") + Dv_DetailTmp.Item(iRow).Item("TIEN_THUONG_SALE")
            nTong_luong = nTong_luong + Dv_DetailTmp.Item(iRow).Item("Tien_thuong")
            Dv_DetailTmp.Item(iRow).EndEdit()

        Next
        TxtT_HH_TVBH.Double = n_t_HH_TVBH
        Txtt_phat_ct.Double = nt_phat_ct
        Txtt_HH_KD.Double = nt_HH_KD
        Txtt_luong_sale.Double = nt_luong_sale
        TxtT_luong_50.Double = nt_luong_50
        TxtTong_luong.Double = nTong_luong
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        Txtt_HH_KD.ReadOnly = True
        Txtt_phat_ct.ReadOnly = True
    End Sub
#End Region
