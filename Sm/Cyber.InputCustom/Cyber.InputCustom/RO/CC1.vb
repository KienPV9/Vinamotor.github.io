...
#Region "Columns Edit"
    ...
    Dim EditNghi_KL, EditNghi_CL, EditCong_lam, EditLam_them_nt, EditLam_them_NL, EditTong_cong As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If (M_Mode <> "M" And M_Mode <> "S") Then
            Exit Sub
        End If
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Get_THC", cmbNam.SelectedValue & "#" & cmdthang.SelectedValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_GetColumn()
        ...
        '----------------------------------------------
        EditCong_lam.GetColumn(DetailGRV, "Cong_lam")
        EditNghi_KL.GetColumn(DetailGRV, "Nghi_KL")
        EditNghi_CL.GetColumn(DetailGRV, "Nghi_CL")
        EditLam_them_NL.GetColumn(DetailGRV, "Lam_them_NL")
        EditLam_them_nt.GetColumn(DetailGRV, "Lam_them_NT")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditNghi_CL.Column Is Nothing Then AddHandler EditNghi_CL.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditNghi_KL.Column Is Nothing Then AddHandler EditNghi_KL.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditCong_lam.Column Is Nothing Then AddHandler EditCong_lam.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLam_them_NL.Column Is Nothing Then AddHandler EditLam_them_NL.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLam_them_nt.Column Is Nothing Then AddHandler EditLam_them_nt.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        If (M_Ma_Dvcs = "10" Or M_Ma_Dvcs = "20") Then
            Exit Sub
        End If
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                ...
                Dv_DetailTmp.Item(iRow).Item("Tong_cong") = Dv_DetailTmp.Item(iRow).Item("Nghi_CL") + Dv_DetailTmp.Item(iRow).Item("Lam_them_NT") + Dv_DetailTmp.Item(iRow).Item("Lam_them_NL") + Dv_DetailTmp.Item(iRow).Item("Cong_lam") - Dv_DetailTmp.Item(iRow).Item("Nghi_KL")
