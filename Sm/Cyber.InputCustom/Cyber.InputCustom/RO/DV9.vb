...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editTien_HH, editma_chucdanh, editis_nghi, editTham_nien, edithe_so_TT, editTien_thuong, editTy_le, editKPIs, EditHe_so_thuong, editDiem_thuong As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    '    If TxTT_Tien_thuong.Double = 0 Then
    '        MsgBox("Bạn chưa nhập tổng tiền thưởng!", MsgBoxStyle.OkOnly, "CYBER")
    '        Exit Sub
    '    Else
    '        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GETCTBP_DV", M_Stt_Rec & "#" & TxtNgay_Ct.Value & "#" & cmbNam.SelectedValue & "#" & cmdthang.SelectedValue & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_GetColumn()
        ...
        editTien_thuong.GetColumn(DetailGRV, "Tien_HH")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditHe_so_thuong.Column Is Nothing Then AddHandler EditHe_so_thuong.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not editTien_thuong.Column Is Nothing Then AddHandler editTien_thuong.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not editTien_HH.Column Is Nothing Then AddHandler editTien_HH.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        '    If Dt_DetailTmp.Rows(iRow).Item("loai").ToString.Trim = "" Then
