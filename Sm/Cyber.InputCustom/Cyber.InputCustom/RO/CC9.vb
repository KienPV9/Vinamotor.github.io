...
#Region "Columns Edit"
    ...
    Dim EditLuong_sau_KPI, EditTong_cong_luong, EditTong_cong_cc8_2 As New Cyber.Fill.CyberColumnGridView
...
#Region "Load And Set And Default"
    ...
    Private Sub V_loadNV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Get_TLuong", CbbMa_GD.SelectedValue & "#" & cmbNam.SelectedValue & "#" & cmdthang.SelectedValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Valid --- Tk"
    ...
    Private Sub V_Ma_KH_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_kh_N.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_kh", "DmKh", "1=1", "1=1")
    End Sub
...
#End Region
    ...
    Private Sub V_GetColumn()
        ...
        EditTong_cong_cc8_2.GetColumn(DetailGRV, "Tong_cong_cc8_2")
        EditTong_cong_luong.GetColumn(DetailGRV, "Tong_cong_luong")
        EditLuong_sau_KPI.GetColumn(DetailGRV, "Luong_sau_KPI")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditTong_cong_cc8_2.Column Is Nothing Then AddHandler EditTong_cong_cc8_2.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditTong_cong_luong Is Nothing Then AddHandler EditTong_cong_luong.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditLuong_sau_KPI.Column Is Nothing Then AddHandler EditLuong_sau_KPI.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim n_luong_sau_kpi As Decimal = 0
        Dim n_luong_khac As Decimal = 0
        Dim n_Tong_cong_luong As Decimal = 0
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            Dv_DetailTmp.Item(iRow).BeginEdit()

            n_luong_sau_kpi = n_luong_sau_kpi + Dv_DetailTmp.Item(iRow).Item("Luong_sau_KPI")
            n_luong_khac = n_luong_khac + Dv_DetailTmp.Item(iRow).Item("Tong_cong_cc8_2")
            Dv_DetailTmp.Item(iRow).Item("Tong_cong_luong") = Dv_DetailTmp.Item(iRow).Item("Luong_sau_KPI") + Dv_DetailTmp.Item(iRow).Item("Tong_cong_cc8_2")
            n_Tong_cong_luong = n_Tong_cong_luong + Dv_DetailTmp.Item(iRow).Item("Tong_cong_luong")
            Dv_DetailTmp.Item(iRow).EndEdit()

        Next

        TxtTien_luong.Double = n_luong_sau_kpi
        TxtLuong_thuong_khac.Double = n_luong_khac
        TxtTong_tien_luong.Double = n_Tong_cong_luong
...
#Region "Button"
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_New()
        'TxtTk.Text = "1111"
        'If TxtTk.Text.Trim <> "" Then If TxtTk.Text.Trim.Trim = "" Then Txtten_Tk.Text = "" Else Txtten_Tk.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_TK", "Dmtk", "(tk= N'" + TxtTk.Text.Trim + "')", CyberSmlib)
        TxtMa_Kh.Text = "VINAMOTOR"
        ...
        TxtMa_kh_N.Text = "VINAMOTOR"
        If TxtMa_kh_N.Text.Trim <> "" Then If TxtMa_Kh.Text.Trim.Trim = "" Then txtTen_KH_N.Text = "" Else txtTen_KH_N.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_kh", "Dmkh", "(Ma_kh= N'" + TxtMa_kh_N.Text.Trim + "')", CyberSmlib)

        'TxtMa_Kh.Text = "KHDN00.0356"
        '-----------------------
        '-----------------
        CyberMe.V_SetEnabled(Me, M_Mode, Dt_Master)
        V_Setstatus()
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtTien_luong.ReadOnly = True
        TxtTong_tien_luong.ReadOnly = True
    End Sub
#End Region
