...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtTien_KT.TextChanged, AddressOf V_Tien_Thua
    End Sub
...
#Region "Valid --- Tk"
    ...
    Private Sub L_Tk(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        CyberSupport.V_SetSD(StatusFooter1, AppConn, "KT", M_Mode, TxtTk.Text, TxtMa_Kh.Text, "", "", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    Private Sub V_Tien_Thua(ByVal sender As Object, ByVal e As System.EventArgs)
        'If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Tien_tt As Double, tien_kt As Double, tien_thua As Double
        Tien_tt = TxtT_TT.Double
        tien_kt = TxtTien_KT.Double
        tien_thua = tien_kt - Tien_tt
        TxtTien_Thua.Double = tien_thua
    End Sub
#End Region
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub GetDetail()
        ...
        If DsSo_Lenh.Tables(1).Columns.Contains("Tk_No") Then TxtTk.Text = DsSo_Lenh.Tables(1).Rows(0).Item("Tk_No")
