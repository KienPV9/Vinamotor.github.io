...
#End Region
    Private Sub PDC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetail(ByVal _Loai As String, ByVal _So As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetPDC", _Loai & "#" & _So & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
