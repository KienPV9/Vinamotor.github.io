...
#Region "Columns Edit"
    ...
    Dim EditThue_Suat, EditTien_Nt3, EditTien3, EditMa_Thue As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Thue_Suat As String = DrReturn("Thue_Suat").ToString.Trim
        Dim _Ma_thue As String = DrReturn("Ma_thue").ToString.Trim
        Dv_DetailTmp.Item(iRow).BeginEdit()
        ...
        Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = IIf(Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = 0, _Thue_Suat, Dv_DetailTmp.Item(iRow).Item("Thue_Suat").ToString.Trim)
        Dv_DetailTmp.Item(iRow).Item("Ma_thue") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_thue").ToString.Trim = "", _Ma_thue, Dv_DetailTmp.Item(iRow).Item("Ma_thue").ToString.Trim)
...
#Region "Xem phiếu nhập"
    Private Sub V_CopyDMSCV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        '1. luu vao table DMS
        Dim dt As DataTable = CyberSmodb.OpenTableKey(AppConn, Nothing, "Dm_luuPOD", "Muc_dich", "1=0", Nothing)
        ...
        For Each Muc_dich As String() In cleanLines
            ...
            If Muc_dich.Length > dataRow.ItemArray.Length Then
                Return
            End If

            For i As Integer = 0 To Muc_dich.Length - 1
                dataRow(i) = Muc_dich(i)
            Next

            dt.Rows.Add(dataRow)
        Next

        CyberSmodb.V_CyberBulkSaveToSQL(AppConn, osysvar, M_User_Name, dt, "Dm_luuPOD", M_Mode, "1=1", True)
        Dt_DetailTmp.Clear()
        '2. Lay tu table DMS ra do vao Grid
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetDMS_POD", M_Stt_Rec & "#" & M_Ma_CT.Trim & "#" & TxtMa_Dvcs.Text.Trim & "#" & M_User_Name)
