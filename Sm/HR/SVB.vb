...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtMa_LoaiVB.CyberValiting, AddressOf V_Ma_LoaiHinh
        AddHandler TxtMa_LoaiVB.CyberLeave, AddressOf L_Ma_LoaiHinh
        '----------------------------------------------------------------------------------------------------------
    End Sub
...
#End Region
#Region "Valid - Detail"
#Region "Valid --- Ma_LoaiHinh"
    Private Sub V_Ma_LoaiHinh(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_Loai", "DmLoaiVB", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_LoaiHinh(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_Hs_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("Ma_BP_I") = DrReturn("Ma_BP")
