...
#Region "Columns Edit"
    ...
    Dim EditSo_Thang_Cam_Ket, EditNgay_HH_Cam_Ket, EditTen_hs, editma_cty As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ten_hs").ToString.Trim = "" Then
