...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editma_bp, editma_chucvu_i As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        editma_chucvu_i.GetColumn(DetailGRV, "Ma_chucvu_i")
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_HS_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Ma_ChucVu_i") = ""
            Dv_DetailTmp.Item(iRow).Item("Ma_BP_i") = ""
        ...
        Else
            ...
            Dv_DetailTmp.Item(iRow).Item("Ma_ChucVu_I") = DrReturn("Ma_ChucVu").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ma_BP_i") = DrReturn("Ma_BP").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ma_BP") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_BP") = "", Dv_DetailTmp.Item(iRow).Item("Ma_BP"), DrReturn("Ma_BP").ToString.Trim)
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
    ...
    Private Sub L_Ma_BP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("ma_bp") = DrReturn("ma_bp")
        Dv_DetailTmp.Item(iRow).Item("ten_bp") = DrReturn("ten_bp")
