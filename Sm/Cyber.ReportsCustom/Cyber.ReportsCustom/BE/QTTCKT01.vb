Public Class QTTCKT01
    Dim DtThang1, DtThang2, DtNam As DataTable
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DtDmMauBc, _DtTTCP As DataTable
    Dim _DsTmp As DataSet
    Private Sub QTTCKT01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DtDmMauBc = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "DmMauBC", "FILE_MauBC", "Acti=N'1' AND Ma_MauBc =N'GLTC9'", CyberSmLib)
        CyberFill.V_FillComBoxDefaul(Me.Cbb_LoaiBC, DtDmMauBc, "File_MauBC", IIf(Me.LAN = "V", "Ten_mauBC", "Ten_MauBc2"), "Ngam_Dinh")
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & Me.Cbb_LoaiBC.SelectedValue.ToString.Trim()
