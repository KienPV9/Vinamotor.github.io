...
#End Region
    ...
    Private Sub V_LoadThangNam()
        ...
        Dim DsTmp As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_Loadtinh", "")
        Nam = DsTmp.Tables(1).Copy
        CyberFill.V_FillComBoxDefaul(Me.Cmbnam, Nam, "Ma_nam", "ten_nam", "ngam_dinh")

        '------------------------------------------------------------
        Thang = DsTmp.Tables(2).Copy
        CyberFill.V_FillComBoxDefaul(Me.CmdThang, Thang, "Ma_thang", "ten_thang", "ngam_dinh")
