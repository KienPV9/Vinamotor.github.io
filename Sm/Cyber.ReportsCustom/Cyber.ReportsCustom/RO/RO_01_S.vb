...
#End Region
    Private Sub V_Load()
        ...
        Dim _DsLoai_Phieu As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable2", "SysNhapXuat#CP_NAME= N'HDK_HDM_HDP' AND Acti = N'1'#ID")
    ...
    Private Sub V_LoadMa_GD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End Try
        If _Ma_Ct = "HDKHDP" Then _Ma_Ct = "HDK"
