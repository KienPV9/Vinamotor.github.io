...
#End Region
    ...
    Private Sub V_LoadThangNam()
        ...
        Dim DsTmp1 As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_LoadBH", "")
        Loai_BH = DsTmp1.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(Me.cmdLoai_BH, Loai_BH, "Ma_Loai", "ten_Loai", "ngam_dinh")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_loai As String = Me.cmdLoai_BH.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & M_loai
