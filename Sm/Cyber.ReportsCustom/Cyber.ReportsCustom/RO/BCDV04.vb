...
#Region "Load"
    ...
    Private Sub V_Load()
        ...
        _Dsstatus1.Dispose()
        Me.CyberFill.V_FillComBoxDefaul(Me.Cmbloai_vt, _Dsstatus1, "ma_nh", "Ten_nh", "Ngam_dinh")
        '----Set
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Loai_vt As String = CmbLoai_vt.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & _Loai_vt
