...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtLenh_Ro.Text = "" Then
            MsgBox("Bạn chưa nhập số lệnh !", MsgBoxStyle.OkOnly, "Cyber")
            Exit Sub
        End If
        '-----------------------------------------------------------------------------
        ...
        M_strParameterStore = M_strParameterStore & "#" & TxtLenh_Ro.Text.Trim
