Public Class BC_BBDCCN
    Dim CyberMe As New Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub BC_BBDCCN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Me.Para(Me.VT_PARA + 1).Trim.ToUpper = "CP_BC_BBDCCN" Then
        ...
        M_strParameterStore = M_strParameterStore + "#C"
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Dvcs_Filter
        M_strParameterStore = M_strParameterStore & "#" & CyberMe.GetLoai_BC(ChkVND, ChkNT)
        M_strParameterStore = M_strParameterStore & "#" & Me.User_Name.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtTen_DD1.Text.Trim + "#" + TxtCV_DD1.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtTen_DD2.Text.Trim + "#" + TxtCV_DD2.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtNoi_Dung.Text.Trim
        '-----------------------------------------------------------------------------

        Me.is_continue = True
        Const M_strFieldValue As String = ""
        Const M_strFieldName As String = ""
